...
# ------------------------
# 紧急通知
紧急通知，TuuzCN服务器水冷崩坏，目前5SSD+1HDD全废，接口烧黑了，接在别的电脑上也无法识别，所以应该是救不回来了了，好在今年的程序在github上都有备份，数据库SSD盘因为是NVME的，位置比较好，躲过一劫，数据库没有进水，理论上应该可用，但毕竟这次是严重的掉电，加上服务器有内存缓存系统，数据库是否完好，我们完全不知道，能否恢复回来无法保证

目前因为数据全丢，所以所有端均不可用，包括Bot项目，请等待恢复，恢复时间将会在1个月左右，建议着急的朋友可以准备换软件了

Best regard & see u soon
